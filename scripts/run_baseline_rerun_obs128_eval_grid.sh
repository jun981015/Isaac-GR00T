...
OUTPUT_ROOT="${OUTPUT_ROOT:-${REPO_DIR}/local_outputs/robocasa_benchmark/baseline_rerun_seed1_50ep_obs128_20260428}"
...
for task in "${tasks[@]}"; do
  cname="isaac-gr00t-robocasa-bench-baseline-rerun-obs128-ckpt20000-${task}"
  output_dir="${OUTPUT_ROOT}/baseline/ckpt20000"
...
echo "[$(date '+%Y-%m-%d %H:%M:%S')] baseline rerun obs128 eval complete"
