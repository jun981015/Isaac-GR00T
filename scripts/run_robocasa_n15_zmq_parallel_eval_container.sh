...
if [[ -n "${OMP_NUM_THREADS}" ]]; then
  DOCKER_ENV_ARGS+=(-e "OMP_NUM_THREADS=${OMP_NUM_THREADS}")
fi
if [[ -n "${MKL_NUM_THREADS}" ]]; then
  DOCKER_ENV_ARGS+=(-e "MKL_NUM_THREADS=${MKL_NUM_THREADS}")
fi
if [[ -n "${OPENBLAS_NUM_THREADS}" ]]; then
  DOCKER_ENV_ARGS+=(-e "OPENBLAS_NUM_THREADS=${OPENBLAS_NUM_THREADS}")
fi
if [[ -n "${NUMEXPR_NUM_THREADS}" ]]; then
  DOCKER_ENV_ARGS+=(-e "NUMEXPR_NUM_THREADS=${NUMEXPR_NUM_THREADS}")
fi
