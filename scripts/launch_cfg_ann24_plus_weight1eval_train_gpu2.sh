...
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_DIR}/local_outputs/robocasa_cfg_retrain/ann24_plus_weight1eval_cfgdrop${DROPOUT//./}_b${BATCH_SIZE}_${MAX_STEPS}step_gpu${GPU}_${TIMESTAMP}}"
LOG_DIR="${LOG_DIR:-${OUTPUT_DIR}/logs}"
WANDB_DIR="${WANDB_DIR:-${OUTPUT_DIR}/wandb}"
WANDB_PROJECT="${WANDB_PROJECT:-robocasa-cfg-finetune}"
WANDB_MODE="${WANDB_MODE:-online}"
WANDB_NAME="${WANDB_NAME:-cfg_ann24_plus_weight1eval_drop${DROPOUT}_b${BATCH_SIZE}_${MAX_STEPS}step_gpu${GPU}_${TIMESTAMP}}"
DETACH="${DETACH:-1}"
